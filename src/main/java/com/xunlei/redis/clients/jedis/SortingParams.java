...
public class SortingParams {
  ...
  public SortingParams by(final byte[] pattern) {
    params.add(Protocol.Keyword.BY.raw);
    params.add(pattern);
    return this;
  }
  ...
  public SortingParams nosort() {
    params.add(Protocol.Keyword.BY.raw);
    params.add(Protocol.Keyword.NOSORT.raw);
    return this;
  }
  ...
  public SortingParams desc() {
    params.add(Protocol.Keyword.DESC.raw);
    return this;
  }
  ...
  public SortingParams asc() {
    params.add(Protocol.Keyword.ASC.raw);
    return this;
  }
  ...
  public SortingParams limit(final int start, final int count) {
    params.add(Protocol.Keyword.LIMIT.raw);
  ...
  public SortingParams alpha() {
    params.add(Protocol.Keyword.ALPHA.raw);
    return this;
  }
  ...
  public SortingParams get(String... patterns) {
    for (final String pattern : patterns) {
      params.add(Protocol.Keyword.GET.raw);
