...
import com.xunlei.redis.clients.jedis.Protocol;
...
public class AllKindOfValuesCommandsTest extends JedisCommandTestBase {
  ...
  public void randomKey() {
    Assert.assertEquals(null, jedis.randomKey());
  ...
  public void select() {
    ...
    assertEquals("OK", bstatus);
    Assert.assertEquals(null, jedis.get(bfoo));
  ...
  public void psetex() {
    ...
    assertTrue(Protocol.Keyword.OK.name().equalsIgnoreCase(status));
  ...
  public void setNxExAndGet() {
    String status = jedis.set("hello", "world", SetParams.setParams().nx().ex(expireSeconds));
    assertTrue(Protocol.Keyword.OK.name().equalsIgnoreCase(status));
    String value = jedis.get("hello");
    assertEquals("world", value);

    jedis.set("hello", "bar", SetParams.setParams().nx().ex(expireSeconds));
    ...
    String bstatus = jedis.set(bworld, bhello, SetParams.setParams().nx().ex(expireSeconds));
    assertTrue(Protocol.Keyword.OK.name().equalsIgnoreCase(bstatus));
    byte[] bvalue = jedis.get(bworld);
    assertTrue(Arrays.equals(bhello, bvalue));

    jedis.set(bworld, bbar, SetParams.setParams().nx().ex(expireSeconds));
