...
public class SetCommandsTest extends JedisCommandTestBase {
  ...
  public void smembers() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpected, bmembers);
  }
  ...
  public void srem() {
    ...
    assertEquals(1, bstatus);
    AssertUtil.assertByteArraySetEquals(bexpected, jedis.smembers(bfoo));
  ...
  public void smove() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpectedSrc, jedis.smembers(bfoo));
    AssertUtil.assertByteArraySetEquals(bexpectedDst, jedis.smembers(bbar));
  ...
  public void sinter() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpected, bintersection);
  }
  ...
  public void sinterstore() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpected, jedis.smembers(bcar));
  ...
  public void sunion() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpected, bunion);
  ...
  public void sdiff() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpected, bdiff);
