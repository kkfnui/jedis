...
import static com.xunlei.redis.clients.jedis.ScanParams.SCAN_POINTER_START;
import static com.xunlei.redis.clients.jedis.ScanParams.SCAN_POINTER_START_BINARY;
...
import com.xunlei.redis.clients.jedis.ScanResult;
import com.xunlei.redis.clients.jedis.Tuple;
import com.xunlei.redis.clients.jedis.ZParams;
...
import com.xunlei.redis.clients.jedis.tests.utils.AssertUtil;
import org.junit.Test;

import com.xunlei.redis.clients.jedis.ScanParams;
...
public class SortedSetCommandsTest extends JedisCommandTestBase {
  ...
  public void zrange() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpected, brange);
  ...
  public void zrangeByLexBinary() {
    ...
    AssertUtil.assertByteArraySetEquals(bExpected, jedis.zrangeByLex(bfoo, bInclusiveB, bExclusiveC));
    ...
    // with LIMIT
    AssertUtil.assertByteArraySetEquals(bExpected, jedis.zrangeByLex(bfoo, bLexMinusInf, bLexPlusInf, 0, 2));
  }
  ...
  public void zrevrangeByLexBinary() {
    ...
    AssertUtil.assertByteArraySetEquals(bExpected, jedis.zrevrangeByLex(bfoo, bExclusiveC, bInclusiveB));
    ...
    // with LIMIT
    AssertUtil.assertByteArraySetEquals(bExpected, jedis.zrevrangeByLex(bfoo, bLexPlusInf, bLexMinusInf, 0, 2));
  }
  ...
  public void zrem() {
    ...
    assertEquals(1, bstatus);
    AssertUtil.assertByteArraySetEquals(bexpected, jedis.zrange(bfoo, 0, 100));
  ...
  public void zrangebyscore() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpected, brange2);
  ...
  public void zremrangeByLexBinary() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpected, jedis.zrangeByLex(bfoo, bLexMinusInf, bLexPlusInf));
  }
